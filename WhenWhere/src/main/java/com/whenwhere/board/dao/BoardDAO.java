...
public interface BoardDAO {
	...
	public List<BoardVO> noticeList(@Param("boardCode") String boardCode, @Param("rowcnt") int rowcnt,
	...
	public int inserteventBoard(@Param("title") String title, @Param("content") String content,
			@Param("auth") String auth, @Param("sDate") Date sdate, @Param("eDate") Date edate,
			@Param("category") String boardCode, @Param("loc") String loc);
	...
	public List<BoardVO> ReviewboardList(@Param("boardCode") String boardCode, @Param("rowcnt") int rowcnt,
			@Param("pageNum") int pageNum);
}
