				...
				<div class="cd-login">
					<form class="cd-form text-center">
						...
						<p class="fieldset top_fieldset">
							...
							<br /> <a href="#joinModal" data-toggle="modal"><button
									class="btn btn-primary btn-lg center-block" type="submit"
									data-toggle="modal" aria-hidden="true" data-dismiss="modal">join
									us</button></a>
						</p>
					</form>
				</div>
				...
				<div class="contentwrap">
					<form class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="email" class="full-width has-padding has-border"
						...
						<div class="form-group">
							<label for="inputNumberCheck" class="col-sm-3 control-label">인증번호
								확인</label>
							<div class="col-sm-6">
								<input type="text" class="full-width has-padding has-border"
									id="inputNumberCheck" placeholder="인증번호입력">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="password" class="full-width has-padding has-border"
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="password" class="full-width has-padding has-border"
									id="inputPasswordCheck" placeholder="비밀번호 확인">
