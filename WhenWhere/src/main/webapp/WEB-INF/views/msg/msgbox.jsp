					...
					<div class="box box-solid">
						<div class="box-body no-padding">
							<ul class="nav nav-pills nav-stacked">
								<li class="inbox"><a
									href="../user/msgbox?type=inbox&page=1"><i
										class="fa fa-inbox"></i> 받은 쪽지함 <span
										class="label label-primary pull-right">3</span></a></li>
								<li class="sent"><a href="../user/msgbox?type=sent&page=1"><i
										class="fa fa-envelope-o"></i> 보낸 쪽지함</a></li>
								<li class="outbox"><a
									href="../user/msgbox?type=outbox&page=1"><i
										class="fa fa-envelope"></i> 보관함</a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			for (var i = "${pagination.getLinkBegin()}"; i <= "${pagination.getLinkEnd()}"; i++) {
				str += "<li><a href='../user/msgbox?type=${type}&page=" + i
						+ "'>" + i + "</li>";
			}
