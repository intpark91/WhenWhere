					...
					<div
						...
						<div id="all" class="clearfix">
							...
							<form id="inForm" name="inForm" method="post"
								action="reviewinsert" enctype="multipart/form-data">
								...
								<div class="con_area">
												...
												<tbody>
													...
													<tr>
														...
														<td class="bbs_name"><input type="text"
															readonly="readonly" name="auth" id="userNick"
															value="${sessionScope.member.nickname}"></td>
													</tr>
													<tr>
														<th scope="row"><label for="location">지역</label></th>
														<td class="bbs_location"><select name="location"
															id="location" class="location">
									...
									<div class="bbs_btn">
										...
										<p class="fr">
											...
											<a href="../board/review?category=3" class="btn btn-info pull-right">취소</a>
